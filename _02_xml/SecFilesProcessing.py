...
class SecXmlFilesProcessor:
    ...
    def _download(self, select_funct:Callable):
        pool = Pool(8)
    ...
    def downloadNumFiles(self):
        self._download(self.dbmanager.find_missing_xmlNumFiles)

    def downloadPreFiles(self):
        self._download(self.dbmanager.find_missing_xmlPreFiles)
