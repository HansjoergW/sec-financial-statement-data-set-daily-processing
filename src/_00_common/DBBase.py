...
class DB(ABC):
    ...
    def create_processing_test_data(self):
        inserts = [
            "INSERT INTO sec_report_processing ('accessionNumber', 'formType', 'filingDate', 'cikNumber', 'xbrlInsUrl', 'xbrlPreUrl', 'xmlNumFile', 'xmlPreFile') VALUES ('0001437749-21-004277', '10-K', '02/26/2021', '0000021535', 'https://www.sec.gov/Archives/edgar/data/21535/000143774921004277/cohu20201226_10k_htm.xml', 'https://www.sec.gov/Archives/edgar/data/21535/000143774921004277/cohu-20201226_pre.xml', '{0}cohu20201226_10k_htm.xml', '{0}cohu-20201226_pre.xml');".format(
                self.TESTDATA_PATH),
            "INSERT INTO sec_report_processing ('accessionNumber', 'formType', 'filingDate', 'cikNumber', 'xbrlInsUrl', 'xbrlPreUrl', 'xmlNumFile', 'xmlPreFile') VALUES ('0001015328-21-000057', '10-K', '02/26/2021', '0001015328', 'https://www.sec.gov/Archives/edgar/data/1015328/000101532821000057/wtfc-20201231_htm.xml', 'https://www.sec.gov/Archives/edgar/data/1015328/000101532821000057/wtfc-20201231_pre.xml', '{0}wtfc-20201231_htm.xml', '{0}wtfc-20201231_pre.xml');".format(
                self.TESTDATA_PATH),
            "INSERT INTO sec_report_processing ('accessionNumber', 'formType', 'filingDate', 'cikNumber', 'xbrlInsUrl', 'xbrlPreUrl', 'xmlNumFile', 'xmlPreFile') VALUES ('0001654954-21-002132', '10-K', '02/26/2021', '0001375205', 'https://www.sec.gov/Archives/edgar/data/1375205/000165495421002132/urg_10k_htm.xml', 'https://www.sec.gov/Archives/edgar/data/1375205/000165495421002132/urg-20201231_pre.xml', '{0}urg_10k_htm.xml', '{0}urg-20201231_pre.xml');".format(
                self.TESTDATA_PATH),
            "INSERT INTO sec_report_processing ('accessionNumber', 'formType', 'filingDate', 'cikNumber', 'xbrlInsUrl', 'xbrlPreUrl', 'xmlNumFile', 'xmlPreFile') VALUES ('0000073756-21-000023', '10-K', '02/26/2021', '0000073756', 'https://www.sec.gov/Archives/edgar/data/73756/000007375621000023/oii-20201231_htm.xml', 'https://www.sec.gov/Archives/edgar/data/73756/000007375621000023/oii-20201231_pre.xml', '{0}oii-20201231_htm.xml', '{0}oii-20201231_pre.xml');".format(
                self.TESTDATA_PATH),
            "INSERT INTO sec_report_processing ('accessionNumber', 'formType', 'filingDate', 'cikNumber', 'xbrlInsUrl', 'xbrlPreUrl', 'xmlNumFile', 'xmlPreFile') VALUES ('0001564590-21-009508', '10-K', '02/26/2021', '0001725057', 'https://www.sec.gov/Archives/edgar/data/1725057/000156459021009508/cday-10k_20201231_htm.xml', 'https://www.sec.gov/Archives/edgar/data/1725057/000156459021009508/cday-20201231_pre.xml', '{0}cday-10k_20201231_htm.xml', '{0}cday-20201231_pre.xml');".format(
                self.TESTDATA_PATH),
            "INSERT INTO sec_report_processing ('accessionNumber', 'formType', 'filingDate', 'cikNumber', 'xbrlInsUrl', 'xbrlPreUrl', 'xmlNumFile', 'xmlPreFile') VALUES ('0001273685-21-000032', '10-K', '02/26/2021', '0001273685', 'https://www.sec.gov/Archives/edgar/data/1273685/000127368521000032/nymt-20201231_htm.xml', 'https://www.sec.gov/Archives/edgar/data/1273685/000127368521000032/nymt-20201231_pre.xml', '{0}nymt-20201231_htm.xml', '{0}nymt-20201231_pre.xml');".format(
                self.TESTDATA_PATH),
            "INSERT INTO sec_report_processing ('accessionNumber', 'formType', 'filingDate', 'cikNumber', 'xbrlInsUrl', 'xbrlPreUrl', 'xmlNumFile', 'xmlPreFile') VALUES ('0001564590-21-009507', '10-K', '02/26/2021', '0001816816', 'https://www.sec.gov/Archives/edgar/data/1816816/000156459021009507/grsv-10k_20201231_htm.xml', 'https://www.sec.gov/Archives/edgar/data/1816816/000156459021009507/grsv-20201231_pre.xml', '{0}grsv-10k_20201231_htm.xml', '{0}grsv-20201231_pre.xml')".format(
                self.TESTDATA_PATH)
        ]
